  ...
  class Handler {
      constructor(containerId, mode) {
          ...
          if (this.handlerMode === 1) {
              this.loadIframe('https://demo.blinderai.com/widgets/index.html?cache_bust=' + new Date().getTime());
          }
          else {
              this.loadIframe('https://demo.blinderai.com/widgets/certonly.html?cache_bust=' + new Date().getTime());
          }
